...
<aside id="sidebar"
    class="fixed lg:static inset-y-0 left-0 z-30 w-72 bg-white border-r border-border flex flex-col shadow-xl transition-transform duration-300 transform -translate-x-full lg:translate-x-0">
