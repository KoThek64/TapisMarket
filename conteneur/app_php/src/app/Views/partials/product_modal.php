<div id="productModal" class="fixed inset-0 z-50 hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    ...
    <div class="fixed inset-0 z-10 overflow-y-auto">
        <div class="flex min-h-full items-center justify-center p-4 text-center">
            ...
            <div
                class="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-2xl transition-all w-full max-w-2xl border border-white/20">
                ...
                <div class="px-6 py-6">
                    <div class="flex flex-col md:flex-row gap-8">
                        ...
                        <div class="w-full md:w-1/2 flex flex-col gap-4">
                            <div
                                class="aspect-square bg-gray-100 rounded-xl overflow-hidden border border-border flex items-center justify-center shadow-inner relative group">
                                <img id="modal-main-img" src="" alt="Product"
                                    class="w-full h-full object-contain hidden transition-transform duration-500 group-hover:scale-105">
                        ...
                        <div class="w-full md:w-1/2 flex flex-col justify-between">
                            <div class="space-y-5">
                                <div>
                                    <p class="text-[10px] font-bold text-muted uppercase tracking-widest mb-1">Produit
                                    </p>
                                    <h4 id="modal-titre"
                                        class="font-serif text-2xl font-bold text-primary leading-tight"></h4>
                                </div>

                                <div class="flex items-end justify-between border-b border-border pb-4">
                                    <div>
                                        <p class="text-[10px] font-bold text-muted uppercase tracking-widest mb-1">Prix
                                        </p>
                                        <p id="modal-prix"
                                            class="text-3xl font-bold text-accent font-serif tracking-tighter"></p>
                                    </div>
                                    <div class="text-right">
                                        <p class="text-[10px] font-bold text-muted uppercase tracking-widest mb-1">Stock
                                        </p>
                                ...
                                <div>
                                    ...
                                    <div class="bg-gray-50 p-3 rounded-lg border border-border">
                                        <p id="modal-desc"
                                            class="text-xs text-gray-600 leading-relaxed italic max-h-32 overflow-y-auto custom-scrollbar">
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="bg-gray-50 px-6 py-4 border-t border-border flex justify-end">
                    <button onclick="closeModal()"
                        class="text-xs font-bold uppercase tracking-widest text-muted hover:text-primary transition px-4 py-2">Fermer</button>
                </div>
            </div>
        </div>
    </div>
