                                        ...
                                        <?php if (isset($user->seller_status)): ?>
                                            <?php if ($user->seller_status === 'VALIDATED'): ?>
                                                <div class="relative group cursor-default">
                                                    <span
                                                        class="h-3 w-3 block rounded-full bg-green-500 shadow-sm border border-green-200"></span>
                                                    <span
                                                ...
                                                <div class="relative group cursor-default">
                                                    <span class="relative flex h-3 w-3">
                                                        <span
                                                            class="animate-ping absolute inline-flex h-full w-full rounded-full bg-orange-400 opacity-75"></span>
                                                        <span
                                                            class="relative inline-flex rounded-full h-3 w-3 bg-orange-500 border border-orange-200"></span>
                                                    </span>
                                                    <span
                                            ...
                                            <?php elseif ($user->seller_status === 'REFUSED'): ?>
                                                <div class="relative group cursor-default">
                                                    <span
                                                        class="h-3 w-3 block rounded-full bg-red-500 shadow-sm border border-red-200"></span>
                                                    <span
