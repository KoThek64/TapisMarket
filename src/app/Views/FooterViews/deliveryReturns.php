...
<head>
    <meta charset="utf-8">
    <title>Livraison & Retours - TapisMarket</title>
        ...
        <div class="max-w-4xl mx-auto px-6 py-16">
            ...
            <div class="space-y-12 bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-slate-100">
                ...
                <div class="bg-blue-50 border border-blue-100 p-6 rounded-xl text-blue-800 text-sm leading-relaxed">
                    <strong>Note importante :</strong> Les tapis sont des objets volumineux. Merci de suivre scrupuleusement la procédure d'emballage ci-dessous pour garantir l'acceptation de votre retour.
                </div>
                ...
                <section>
                    ...
                    <p class="text-slate-600 leading-relaxed">
                        ...
                        Pour initier un retour, rendez-vous dans votre espace "Mon Compte" > "Mes Commandes" et cliquez sur "Retourner un article". Vous recevrez par email une étiquette de transport prépayée.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <div class="text-slate-600 leading-relaxed space-y-3">
                        ...
                        <ul class="list-disc pl-5 space-y-2 marker:text-blue-500">
                            <li><strong>Roulez le tapis</strong> serré (ne le pliez jamais, cela marque la fibre définitivement).</li>
                ...
                <section>
                    ...
                    <p class="text-slate-600 leading-relaxed">
                        Collez l'étiquette de retour sur l'emballage. Selon la taille du tapis, un transporteur viendra le récupérer chez vous sur rendez-vous, ou vous pourrez le déposer en point relais (pour les petits formats).<br><br>
                        Le remboursement sera effectué sur votre moyen de paiement d'origine sous <strong>14 jours</strong> après réception et vérification de l'état du tapis à notre entrepôt.
                    </p>
                </section>
