...
<div class="flex flex-col items-center justify-center text-center px-4 min-h-[60vh] w-full max-w-3xl mx-auto">
    ...
    <div class="flex flex-col items-center gap-6">
        <p class="text-sm text-gray-400 font-medium flex items-center justify-center gap-2 bg-gray-50 px-4 py-2 rounded-full">
        ...
        <a href="<?= base_url('/') ?>" class="group bg-primary text-white px-8 py-3.5 rounded-xl font-bold text-sm hover:bg-accent transition-all duration-300 shadow-lg hover:shadow-accent/20 flex items-center gap-2">
