...
<div class="min-h-screen bg-cream font-sans flex items-center justify-center p-4">
    <div class="max-w-md w-full bg-white rounded-custom border border-border-custom shadow-md-custom p-8 text-center">
        ...
        <div
            class="mb-6 inline-flex items-center justify-center w-16 h-16 bg-cream rounded-full border border-border-light">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-accent" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
