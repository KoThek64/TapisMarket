...
<div class="max-w-4xl mx-auto px-6 py-16">
    ...
    <div class="space-y-12 bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-slate-100">
        ...
        <section>
            ...
            <p class="text-slate-600 leading-relaxed">
                Notre site utilise des cookies techniques essentiels au fonctionnement du panier et de la connexion
                utilisateur. Aucune donnée n'est revendue à des tiers publicitaires. Vous pouvez configurer votre
        ...
        <section>
            ...
            <p class="text-slate-600 leading-relaxed">
                Vous avez le droit de demander l'accès, la modification ou la suppression complète de vos données
                personnelles à tout moment. Pour exercer ce droit, veuillez nous contacter via notre formulaire de
                contact ou par email à privacy@tapismarket.fr.
            </p>
        </section>
