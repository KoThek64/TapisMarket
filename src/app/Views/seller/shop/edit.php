...
<?= $this->section('header_content') ?>
    <a href="<?= site_url('seller/shop') ?>" class="px-4 py-2 rounded-xl bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 transition flex items-center gap-2 shadow-sm font-bold text-sm">
        ...
        <form action="<?= site_url('seller/shop/update') ?>" method="post" class="space-y-6">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="shop_name" class="block text-sm font-medium text-gray-700 mb-1">Nom du magasin</label>
            ...
            <div class="pt-6 border-t border-gray-100 flex justify-end gap-3">
                <a href="<?= site_url('seller/shop') ?>" class="px-5 py-2.5 rounded-xl border border-gray-300 text-gray-700 bg-white hover:bg-gray-50 transition font-medium">
                    Annuler
                </a>
                <button type="submit" class="px-5 py-2.5 rounded-xl bg-accent text-white hover:bg-accent-hover transition font-bold shadow-sm flex items-center gap-2">
