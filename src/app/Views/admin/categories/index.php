...
<?= $this->section('header') ?>
    <?php 
    $headerActions = '
        <a href="'. site_url('/') .'" class="text-xs font-bold text-muted hover:text-primary transition uppercase tracking-wide mr-4">Retour au site</a>
        <a href="'. site_url('admin/categories/create') .'" class="group flex items-center gap-2 px-5 py-2.5 bg-primary text-white rounded-full hover:bg-accent transition-all text-sm font-bold shadow-lg shadow-primary/30 hover:shadow-accent/30">
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-border">
                    ...
                    <tr class="hover:bg-cream transition-colors group">
                        <td class="px-8 py-5">
                            <span class="font-serif text-lg font-bold text-primary group-hover:text-accent transition-colors">
                                <?= esc($cat->name) ?>
                            </span>
                        </td>
                        
                        <td class="px-8 py-5">
                            <span class="px-3 py-1.5 bg-gray-50 border border-border rounded-lg text-xs text-muted font-mono">
                                /<?= esc($cat->alias) ?>
                            </span>
                        </td>
