    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        ...
        <div class="bg-gradient-to-br from-primary to-gray-800 text-white p-6 rounded-2xl shadow-xl relative overflow-hidden group">
            <div class="relative z-10">
                ...
                <h3 class="font-serif text-3xl font-bold tracking-tight"><?= number_format($totalSales, 2, '.', ',') ?> €</h3>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-border relative overflow-hidden group hover:shadow-md transition-all">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <h3 class="font-serif text-3xl font-bold text-primary group-hover:text-accent transition-colors"><?= $totalMod ?></h3>
                </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-border overflow-hidden flex flex-col h-full">
            <div class="px-8 py-6 border-b border-border flex justify-between items-center bg-gray-50/30">
                ...
                <a href="<?= site_url('admin/orders') ?>" class="text-xs font-bold text-accent hover:text-primary uppercase tracking-wide transition font-sans">Tout voir →</a>
            </div>
                            ...
                            <td class="px-8 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="text-sm font-medium text-gray-700">
                                        <?= esc($cmd->firstname) ?> <span class="uppercase text-xs text-muted"><?= esc($cmd->lastname) ?></span>
                                    </div>
                                </div>
                            </td>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-border overflow-hidden flex flex-col h-full">
            <div class="px-8 py-6 border-b border-border flex justify-between items-center bg-gray-50/30">
                ...
                <a href="<?= site_url('admin/users') ?>" class="text-xs font-bold text-accent hover:text-primary uppercase tracking-wide transition">Gérer</a>
            </div>
            <div class="flex-1 overflow-x-auto">
                <table class="w-full text-left">
                    <thead class="bg-white text-xs uppercase text-muted font-bold border-b border-border">
                    ...
                    <tbody class="divide-y divide-border">
                        ...
                        <tr class="hover:bg-cream transition-colors">
                            <td class="px-8 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center text-sm font-bold text-gray-600 shadow-sm">
